...
func (m *CreateDNSRecordModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	var cmd tea.Cmd
	...
	case tea.KeyPressMsg:
		...
		case "enter":
			if m.focusIndex == len(m.inputs) {
				...
				record, err := shared.BuildRecord(m.RecordType, name, ttl, spaceship.DNSRecordGroup{}, fields)
				if err != nil {
					m.Error = err.Error()
					return m, nil
				}
				...
				return m, func() tea.Msg {
					return CloseCreateDNSRecordMsg{Confirmed: true, Record: record}
				}
